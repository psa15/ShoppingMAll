...
public class OrderServiceImpl implements OrderService {
	...
	//주문하기 - 바로구매
	@Override
	public void orderDirectSave(OrderVO orderVO, PaymentVO payVO, Integer p_num, Integer ord_amount) {
		//1) 주문테이블
		orderMapper.insertOrder(orderVO);
		...
		orderMapper.insertDirectOrderDetail(ord_code, p_num, ord_amount);
	...
	//장바구니 외 목록
	@Override
	public OrderCartListVO orderDirectList(Integer p_num, int ord_amount) {
