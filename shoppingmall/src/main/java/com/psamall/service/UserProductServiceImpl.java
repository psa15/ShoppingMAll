...
public class UserProductServiceImpl implements UserProductService {
	...
	public List<CatetgoryVO> firstCateList() {
		return userProductMapper.firstCateList();
	}

	//2차 카테고리
	@Override
	public List<CatetgoryVO> secondCateList(Integer firstCateCode) {
		return userProductMapper.secondCateList(firstCateCode);
	}

	//상품목록
	@Override
	public List<ProductVO> productListBySecondCateCode(Integer s_ct_code, Criteria cri) {
		return userProductMapper.productListBySecondCateCode(s_ct_code, cri);
	}

	//상품 목록 개수 : 페이징 구현 사용
	@Override
	public int productTotalCountBySecondCateCode(Integer s_ct_code, Criteria cri) {
		return userProductMapper.productTotalCountBySecondCateCode(s_ct_code, cri);
	}

	//상품 코드에 맞는 상품 정보
	@Override
	public ProductVO getProductDetail(Integer p_num) {
		return userProductMapper.getProductDetail(p_num);
	}
	...
	public List<ProductVO> getAllProduct() {
		return userProductMapper.getAllProduct();
	}
